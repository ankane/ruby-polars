...
fn init() -> RbResult<()> {
    ...
    class.define_method("lst_unique", method!(RbExpr::list_unique, 1))?;
    class.define_method("lst_get", method!(RbExpr::list_get, 1))?;
    class.define_method("lst_join", method!(RbExpr::list_join, 1))?;
    class.define_method("lst_arg_min", method!(RbExpr::list_arg_min, 0))?;
    class.define_method("lst_arg_max", method!(RbExpr::list_arg_max, 0))?;
    class.define_method("lst_diff", method!(RbExpr::list_diff, 2))?;
    class.define_method("lst_shift", method!(RbExpr::list_shift, 1))?;
    class.define_method("lst_slice", method!(RbExpr::list_slice, 2))?;
    class.define_method("lst_eval", method!(RbExpr::list_eval, 2))?;
    class.define_method("cumulative_eval", method!(RbExpr::cumulative_eval, 3))?;
    class.define_method("lst_to_struct", method!(RbExpr::list_to_struct, 3))?;
